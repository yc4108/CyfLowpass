...
#ifndef CyfLowpassFX_H
#define CyfLowpassFX_H
...
private:
    ...
    std::vector<AkReal32> m_previousInput;
    std::vector<AkReal32> m_previousOutput_2;
    std::vector<AkReal32> m_previousInput_2;
    std::vector<AkReal32> m_xh;
    std::vector<AkReal32> m_xh_2;
    std::vector<AkReal32> m_xh_new;
};

#endif // CyfLowpassFX_H
